...
which is definitely not a Cauchy distribution. By the way, this is one of the weirdest densities I have ever seen, $f(u) \to \infty$ as $u \to 0$ and $f$ is indeterminate at $u = \pm 1$ (the limit may be evaluated using L'hospital's rule). Here is a plot comparing the Cauchy density (black) to its ratio (red). 
